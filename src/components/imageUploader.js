    ...
    if (selectedOption === 'post') {
      ...
      axios
        ...
        .then((response) => {
          ...
          axios
            .post(
              `${baseurl}/api/v1/users/createUploadPostImages/${response.data.data.doc._id.toString()}`,
              formDataImage,
              {
                headers,
              },
            ...
            .then((res) => {
              ...
              axios
                .post(
                  `${baseurl}/api/v1/users/createUploadPostAudios/${response.data.data.doc._id.toString()}`,
                  formDataAudio,
                  {
                    headers,
                  },
      ...
      axios
        ...
        .then((response) => {
          axios
            .post(
              `${baseurl}/api/v1/users/createUploadStoryImage/${response.data.data.doc._id.toString()}`,
              formDataImage,
              {
                headers,
              },
          ...
          axios
            .post(
              `${baseurl}/api/v1/users/createUploadStoryAudio/${response.data.data.doc._id.toString()}`,
              formDataAudio,
              {
                headers,
              },
